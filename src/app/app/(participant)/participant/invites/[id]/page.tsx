...
import { ChevronLeft, Clock, Star, HelpCircle, Users, CheckCircle, X, MapPin, Calendar } from 'lucide-react'
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-3 gap-3 mb-4">
        <div className="bg-white rounded-xl border border-gray-200 p-4 text-center">
          ...
          <p className="text-xl font-bold text-gray-900">{INVITE.totalPotential}pts</p>
          <p className="text-xs text-gray-400 mt-0.5">Total potential</p>
          <p className="text-xs text-gray-400">{INVITE.ratePerQuestion}pts per question</p>
        </div>
        <div className="bg-white rounded-xl border border-gray-200 p-4 text-center">
      ...
      <div className="bg-wizer-purple-xlight border border-wizer-purple-light rounded-xl p-5 mb-8">
        ...
        <div className="space-y-2">
          {[
            ...
            `Each response earns you ${INVITE.ratePerQuestion}pts in your Wizer balance.`,
            'Points can be spent in the Wizer Rewards Shop.',
