    ...
    <div>
      ...
      <div className="flex items-start justify-between gap-6 mb-6">
        ...
        <div className="shrink-0 bg-white border border-gray-200 rounded-xl px-5 py-3 text-right">
          <p className="text-xs text-gray-400 mb-0.5">Available points</p>
          <p className="text-2xl font-bold text-gray-900">{remaining} pts</p>
          {spentTotal > 0 && (
            <p className="text-xs text-green-600 mt-0.5">{spentTotal}pts redeemed this session</p>
          )}
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-wizer-purple-light to-white border border-wizer-purple-light rounded-xl px-5 py-3.5 mb-6 flex items-center gap-3">
        ...
        <p className="text-sm text-wizer-purple-dark">
          <strong>Partner integration active</strong> — points transfer directly to your chosen partner account at checkout. 1 point = $1 value.
        </p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-100">
                ...
                <p className="text-sm font-bold text-gray-900 shrink-0">{product.price}pts</p>
              </div>
                ...
                {isRedeemed ? (
                  ...
                  <div className="space-y-2">
                    <p className="text-xs text-gray-600">
                      Spend <strong>{product.price}pts</strong> on <strong>{product.name}</strong>?
                    </p>
                  ...
                  >
                    {canAfford ? `Redeem — ${product.price}pts` : 'Insufficient points'}
                  </button>
                )}
              </div>
            </div>
