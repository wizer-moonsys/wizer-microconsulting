...
const STATUS_OPTIONS: { value: ActivationStatus; label: string }[] = [
  { value: "draft",     label: "Draft â not visible to client yet" },
  { value: "active",    label: "Active â live and visible to client" },
  { value: "paused",    label: "Paused â visible but not collecting" },
...
function EngagementSetupInner({
  ...
  // ââ Question helpers âââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <p className="text-sm text-muted-foreground mb-6">
        ...
        They will only see the details and live status â not this setup view.
      </p>

      <form onSubmit={handleSave} className="space-y-6">
        {/* ââ Engagement details ââââââââââââââââââââââââââââââââââââââââââââ */}
        <section className="rounded-lg border border-border bg-card p-5 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. Strategic Decision Review â Q2 2026"
              required
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Brief overview of what this engagement covers and what the client can expectâ¦"
              rows={3}
        ...
        {/* ââ Timeline & targets ââââââââââââââââââââââââââââââââââââââââââââ */}
        <section className="rounded-lg border border-border bg-card p-5 space-y-4">
        ...
        <div className="flex gap-3">
          ...
          >
            ...
            {saving ? "Savingâ¦" : activationId ? "Save changes" : "Create engagement"}
          </button>
          <Link
            href={`/org/clients/${params.clientId}`}
